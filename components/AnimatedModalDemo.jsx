...
export function ContactMeModal() {
  return (
    <Modal>
      <ModalTrigger className="bg-blue-500 text-white p-2 rounded">
        Contact Me
      </ModalTrigger>
      <ModalBody>
        <ModalContent>
          <h4 className="text-lg font-bold text-center mb-4">Contact Me</h4>
          <p className="text-center mb-4">Feel free to reach out for any inquiries!</p>
          <form className="flex flex-col items-center">
            <input type="text" placeholder="Your Name" className="mb-2 p-2 border rounded" />
            <input type="email" placeholder="Your Email" className="mb-2 p-2 border rounded" />
            <textarea placeholder="Your Message" className="mb-2 p-2 border rounded" rows="4" />
            <button className="bg-blue-500 text-white p-2 rounded">Send Message</button>
          </form>
        </ModalContent>
        <ModalFooter>
          <button className="px-2 py-1 bg-gray-200 text-black rounded-md">Close</button>
        </ModalFooter>
      </ModalBody>
    </Modal>
  );
...
export function ResumeModal() {
  return (
    <Modal>
      <ModalTrigger className="bg-green-500 text-white p-2 rounded">
        View Resume
      </ModalTrigger>
      <ModalBody>
        <ModalContent>
          <h4 className="text-lg font-bold text-center mb-4">My Resume</h4>
          <p className="text-center mb-4">Here is a brief overview of my professional experience.</p>
          <ul className="list-disc list-inside mb-4">
            <li>Job Title 1 at Company A</li>
            <li>Job Title 2 at Company B</li>
            <li>Job Title 3 at Company C</li>
          </ul>
          <a href="/path/to/resume.pdf" className="text-blue-500 underline">Download Resume</a>
        </ModalContent>
        <ModalFooter>
          <button className="px-2 py-1 bg-gray-200 text-black rounded-md">Close</button>
        </ModalFooter>
