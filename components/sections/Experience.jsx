...
const Experience = () => {
  ...
  return (
    <section
      className="min-h-screen py-20 px-6 lg:px-20 flex items-center"
      id="experience"
    >
            ...
            <div className="relative z-10 bg-gradient-to-br from-zinc-900 to-zinc-950 rounded-3xl p-12 border border-zinc-800">
              <div className="text-center space-y-6">
                <div className="relative">
                  ...
                  <p className="text-2xl text-zinc-400 font-semibold -mt-1">
                    Months
                  </p>
                </div>
            ...
            <div>
              ...
              <div className="flex items-center gap-3 text-zinc-400 mb-6">
                ...
                <span className="text-xl">
                  Superhhero Learning • Kollam, Kerala
                </span>
              </div>
            </div>
            <p className="text-lg text-zinc-400 leading-relaxed">
              Specialized in building high-performance, SEO-focused web
              applications. I led the development of a dynamic educational
              platform and a custom admin dashboard, bridging the gap between
              complex backend logic and user-friendly frontend designs.
            </p>
              ...
              <ul className="space-y-3">
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-zinc-300">
                    Built an SEO-optimized web platform using{" "}
                    <strong>Next.js</strong> and Server-Side Rendering (SSR).
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  <div className="w-6 h-6 rounded-full bg-purple-500/20 flex items-center justify-center flex-shrink-0 mt-0.5">
                  ...
                  <span className="text-zinc-300">
                    Developed a custom Admin Dashboard with{" "}
                    <strong>MongoDB</strong> to manage content and media
                    assets.{" "}
                  </span>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <span className="text-zinc-300">
                    Handled production deployment, including domain
                    configuration and image optimization.{" "}
                  </span>
                </li>
              </ul>
            </div>
